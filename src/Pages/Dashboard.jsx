  ...
  const [themeMode, setThemeMode] = useState(() => {
    ...
    if (document.documentElement) {
      if (document.documentElement.hasAttribute('data-bs-theme-mode')) {
        initialThemeMode = document.documentElement.getAttribute('data-bs-theme-mode');
  ...
  return (
    <>
      ...
      <a
        ...
        data-nit-menu-placement="bottom-end"
      >
        <i className={`nit-dt nit-night-day theme-light-show fs-2qx ${themeMode === 'light' ? 'active' : ''}`}>
        ...
        <i className={`nit-dt nit-moon theme-dark-show fs-1 ${themeMode === 'dark' ? 'active' : ''}`}>
