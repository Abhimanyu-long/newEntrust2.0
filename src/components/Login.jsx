              ...
              <>
                <div className="d-flex flex-column flex-lg-row-fluid py-10 entrustlogin">
                  ...
                  <div className="d-flex flex-center flex-column flex-column-fluid">
                    <div className="w-lg-300px p-10 p-lg-15 mx-auto">
                      <form
                      ...
                      >
                        ...
                        <div className="fv-row mb-10">
                          ...
                          <input
                            ...
                            placeholder="Email"
                            value={
                              forgot ? credentials.email : forgotemail.email
                            }
                        ...
                        <div className="alert alert-dark">
                          ...
                          <div className="fv-row mb-10 fv-plugins-icon-container">
                            <label className="form-check form-check-custom form-check-solid form-check-inline">
                              ...
                              />
                              <span className="form-check-label fw-semibold text-gray-700 fs-6">
                                I agree to receive communications from Neural
                                IT* <br />
                                By agreeing, you consent to allow Neural IT to
                                store and process the personal information
                                submitted above to provide you the content
                                requested.
                              </span>
                            </label>
                            <div className="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
